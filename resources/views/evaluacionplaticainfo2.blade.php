                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="product-payment-inner-st">
                                        ...
                                        <div id="myTabContent" class="custom-product-edit">
                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <div class="dropzone dropzone-custom needsclick addcourse"
                                                                            ...
                                                                            <br>
                                                                            <div><h4 class="textnegritas col-lg-12">
                                                                                    Datos personales</h4>
                                                                            </div>
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="text-center content-box">
                                                                        <h4 class="m-b-xs">¿Cuál es el modelo de
                                                                            emprendimiento
                                                                            adecuado para su proyecto de negocio?</h4>
                                                                        <div class="m icon-box">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="hpanel widget-int-shape res-tablet-mg-t-30 dk-res-t-pro-30">
                                                                <div class="panel-body">
                                                                    <div class="text-center content-box">
                                                                        <h4 class="m-b-xs">Tipo de persona jurídica</h4>
                                                                        <div class="m icon-box">
                                                                            <br>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <select required='true'
                                                                                ...
                                                                                <option value="Persona física">Persona
                                                                                    física
                                                                                </option>
                                                                                <option value="Persona Moral">Persona
                                                                                    Moral
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="hpanel widget-int-shape responsive-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                                                                <div class="panel-body">
                                                                    <div class="text-center content-box">
                                                                        <h4 class="m-b-xs">¿Cuantos años tiene dado de
                                                                            alta
                                                                            en
                                                                            el SAT?
                                                                            </label> </h4>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <select required='true'
                                                                                    ...
                                                                                    <option value="3 o más">3 o más años
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-sm-10 aviso">
                                                    <p>Aviso de Confidencialidad El Fondo Jalisco de Fomento
                                                        Empresarial (FOJAL), ubicado en Av. Adolfo López Mateos Norte
                                                        #1135,
                                                        esquina con Colomos, colonia Italia Providencia, C.P. 44648 en
                                                        la
                                                        ciudad
                                                        de Guadalajara, Jalisco, es responsable del uso y protección de
                                                        sus
                                                        datos
                                                        personales, por ello hace de su conocimiento lo siguiente: los
                                                        datos
                                                        personales
