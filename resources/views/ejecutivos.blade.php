            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="background-color: whiteSmoke;">
                        <form action="ejecutivos" method="POST">{{csrf_field()}}<button type="submit" name="guardar_ejecutivos" id="guardar_ejecutivos" class="btn btn-primary waves-effect waves-light">Guardar</button></form>
