                                                                    ...
                                                                    <div class="form-group">
                                                                        <select required='true' class="form-control"
                                                                            ...
                                                                            @foreach($cat_direcciones as $direccion)
                                                                                <option value="{{$direccion->id_direccion}}">{{$direccion->nom_dir}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <select required='true' class="form-control"
                                                                            ...
                                                                            @foreach($cat_perfiles as $perfiles)
                                                                                <option value="{{$perfiles->id_perfil}}" @if(old('perfil')==$perfiles->id_perfil)selected="selected"@endif
                                                                                >{{$perfiles->nom_perfil}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                ...
                                                                <table id="table" data-toggle="table"
                                                                    ...
                                                                    @foreach ($detalle_registrousuarios as $registro)
                                                                        <tr role="row" class="odd">
                                                                            ...
                                                                            <td class="sorting_1">{{$registro->extension}}</td>
                                                                            ...
                                                                            <td class="sorting_1">
                                                                                ...
                                                                                <button type="button"
                                                                                        ...
                                                                                        class="pd-setting-ed">
                                                                                    <a href='ModificaUsuarios/{{$registro->id_usuario}}'>
