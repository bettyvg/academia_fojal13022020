<?php $__env->startSection('content'); ?>
    <section>
        <form action="<?php echo e(route('temas')); ?>" method="post" class="form-horizontal">
            <?php echo csrf_field(); ?>
                    <?php if(isset($alert2)): ?>
                                                                ...
                                                                <div class="sparkline13-graph">
                                                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                                                        ...
                                                                        <table id="table" data-toggle="table"
                                                                            ...
                                                                            <tbody>
                                                                            <?php $__currentLoopData = $cat_temas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr role="row" class="odd">
                                                                                    <td class="sorting_1"></td>
                                                                                    <td class="sorting_1"><?php echo e($Items->num_sesion); ?></td>
                                                                                    <td class="sorting_1"><?php echo e($Items->tema); ?></td>
                                                                                    <td class="sorting_1">
                                                                                        <button type="button"
                                                                                                title="Editar registro"
                                                                                                class="pd-setting-ed">
                                                                                            <a href='ModificaUsuarios/<?php echo e($Items->id_tema); ?>'>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="background-color: whiteSmoke;">
                        <form action="temas" method="POST"><?php echo e(csrf_field()); ?><button type="submit" name="guardar_temas" id="guardar_temas" class="btn btn-primary waves-effect waves-light">Guardar</button></form>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\academia_fojal\resources\views/temas.blade.php ENDPATH**/ ?>