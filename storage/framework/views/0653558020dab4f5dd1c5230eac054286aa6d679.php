<?php $__env->startSection('content'); ?>
    <section>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="product-payment-inner-st">
                                        <ul id="myTabedu1" class="tab-review-design">
                                            <li class="active"><a href="#description">Instructores</a></li>
                                        </ul>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-offset-8">
                                                                                <div class="payment-adress" >
                                                                                    <br>
                                                                                    <button type="button" class="btn btn-info pull-right" data-toggle="modal" name="agregar_ejecutivos" id="agregar_ejecutivos" data-target="#modal_ejecutivos">Agregar instructor</button>
                                                                                </div>
                                                                            </div>
                                                                            <br>
                                                                        </div>
                                                                <div class="sparkline13-graph">
                                                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                                                        ...
                                                                        <table id="tabla_ejecutivos" name="tabla_ejecutivos" data-toggle="table"
                                                                            ...
                                                                            <tbody>
                                                                            <?php $__currentLoopData = $cat_ejecutivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <tr role="row" class="odd">
                                                                                    <td class="sorting_1"></td>
                                                                                    <td class="sorting_1"><?php echo e($Items->nombre_ejecutivo); ?></td>
                                                                                    <td class="sorting_1"><?php echo e($Items->apellido_paterno); ?></td>
                                                                                    <td class="sorting_1"><?php echo e($Items->apellido_materno); ?></td>
                                                                                    <td class="sorting_1">
                                                                                        <button type="button"
                                                                                                title="Editar registro"
                                                                                                data-toggle="modal" name="editar_ejecutivo" id="editar_ejecutivo" data-target="#editar_ejecutivos"
                                                                                                class="pd-setting-ed">
                                                                                            <a><i class="fa fa-pencil-square-o"> </i></a></button>
        ...
        <br>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="background-color: whiteSmoke;">
                        <form action="ejecutivos" method="POST"><?php echo e(csrf_field()); ?><button type="submit" name="guardar_ejecutivos" id="guardar_ejecutivos" class="btn btn-primary waves-effect waves-light">Guardar</button></form>
            ...
            <div class="modal" tabindex="-1" role="dialog" name="editar_ejecutivos" id="editar_ejecutivos">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: whiteSmoke;">
            ...
            <!--INICIO MODAL AVISO ELIMINACION DE ejecutivos-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <h4 style="text-align: center"><?php echo e(' '.$Items->nombre_ejecutivo .' '.$Items->apellido_paterno.' '.$Items->apellido_materno); ?> ?</h4>
                        </div>
                        <div class="modal-footer danger-md">
                            <button class="btn btn-danger" data-dismiss="modal" href="#" style="text-align: left">Cancel</button><br><br>
                            <form action="delete_ejecutivos/<?php echo e($Items->id_ejecutivo); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\academia_fojal\resources\views/ejecutivos.blade.php ENDPATH**/ ?>