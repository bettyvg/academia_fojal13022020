<?php $__env->startSection('content'); ?>
    ...
    <section>
        <form action="<?php echo e(route('evaluacionp')); ?>" method="post" class="form-horizontal">
                                                        ...
                                                        <div class="from-group">
                                                            <select required='true' class="form-control"  name="id_ejecutivo" id="id_ejecutivo">
                                                                ...
                                                                <?php $__currentLoopData = $cat_ejecutivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejecutivos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($ejecutivos->id_ejecutivo); ?>"><?php echo e($ejecutivos->nombre." ". $ejecutivos->apellido_paterno." ".$ejecutivos->apellido_materno); ?></option>
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <select required='true' class="form-control"  name="municipio" id="municipio">
                                                                    ...
                                                                    <?php $__currentLoopData = $cat_municipios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipios): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($municipios->cve_compuesta_ent_mun); ?>" <?php if($municipios->cve_compuesta_ent_mun == 14039): ?> selected <?php endif; ?>> <?php echo e($municipios->nom_mun); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
...
<?php /* C:\laragon\www\academia_fojal\resources\views/evaluacionplaticainfo1.blade.php */ ?>